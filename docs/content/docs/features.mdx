...
One of the benefits of this implementation is exposing a STAC API for your geospatial collections. Here are a summary of the endpoints that are made publicly available for your CKAN instance once ckanext-gztr is installed:
