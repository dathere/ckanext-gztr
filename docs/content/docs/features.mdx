...
```
County A (Counties), County B (Counties)
```
...
For CKAN instances storing **water data**, you can **sync your water data** with the Geoconnex global water data knowledge graph.
